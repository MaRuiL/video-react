  ...
  (function(_Component) {
    ...
    function ControlBar(props) {
      ...
      _this = (0, _possibleConstructorReturn2.default)(
        this,
        (0, _getPrototypeOf2.default)(ControlBar).call(this, props)
      );
    ...
    (0, _createClass2.default)(ControlBar, [
      {
        ...
        value: function getDefaultChildren() {
          return [
            _react.default.createElement(_PlayToggle.default, {
              key: 'play-toggle',
              order: 1
            }),
      ...
      },
      {
        ...
        value: function getChildren() {
          ...
          var _this$props = this.props,
            ...
            parentProps = (0, _objectWithoutProperties2.default)(_this$props, [
              'className'
            ]); // remove className
