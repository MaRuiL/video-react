  ...
  (function(_Component) {
    ...
    function Video(props) {
      ...
      _this = (0, _possibleConstructorReturn2.default)(
        this,
        (0, _getPrototypeOf2.default)(Video).call(this, props)
      );
      ...
      _this.handleProgress = (0, _utils.throttle)(
    ...
    (0, _createClass2.default)(Video, [
      ...
      },
      {
        ...
        value: function canPlayType() {
          ...
          (_this$video2 = this.video).canPlayType.apply(
            _this$video2,
            arguments
          );
        } // toggle play
