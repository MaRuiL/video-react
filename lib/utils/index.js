...
function formatTime() {
  ...
  var guide =
    arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : seconds;
...
function mergeAndSortChildren(defaultChildren, _children, _parentProps) {
  ...
  var order = _parentProps.order,
    parentProps = (0, _objectWithoutProperties2.default)(_parentProps, [
      'order'
    ]); // ignore order from parent
  ...
  return children
    ...
    .map(function(element) {
      ...
      var e = _react.default.cloneElement(
        element,
        props,
...
function deprecatedWarning(oldMethodCall, newMethodCall) {
  ...
  console.warn(
    'WARNING: '
      .concat(oldMethodCall, ' will be deprecated soon! Please use ')
      .concat(newMethodCall, ' instead.')
  );
}
