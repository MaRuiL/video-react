...
function TimeDivider(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement(
      'div',
      null,
      React.createElement('span', null, separatorText)
    )
  );
}
...
var ControlBar =
  ...
  (function(_Component) {
    ...
    _proto.getDefaultChildren = function getDefaultChildren() {
      return [
        React.createElement(PlayToggle, {
          key: 'play-toggle',
          order: 1
        }),
  ...
  (function(_Component) {
    ...
    _proto.getDefaultChildren = function getDefaultChildren(originalChildren) {
      ...
      return [
        ...
        React.createElement(PosterImage, {
          key: 'poster-image',
          order: 1.0
        }),
    ...
    _proto.getChildren = function getChildren(props) {
      ...
      var children = React.Children.toArray(this.props.children).filter(
        function(e) {
