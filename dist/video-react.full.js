(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : ((global = global || self),
      factory((global['video-react'] = {}), global.React, global.ReactDOM));
  ...
  */
  ...
  var Manager =
    ...
    (function() {
      ...
      _proto.subscribeToOperationStateChange = function subscribeToOperationStateChange(
        listener
      ) {
        var _this = this;
      ...
      _proto.subscribeToPlayerStateChange = function subscribeToPlayerStateChange(
        listener
      ) {
        var _this2 = this;
  ...
  function mergeAndSortChildren(
    ...
    return children
      ...
      .concat(
        defaultChildren.filter(function(c) {
      ...
      .map(function(element) {
        ...
        var e = React__default.cloneElement(
          element,
          props,
  ...
  var Video =
    ...
    (function(_Component) {
      ...
      function Video(props) {
        ...
        _this.handleProgress = throttle(
          _this.handleProgress.bind(
            _assertThisInitialized(_assertThisInitialized(_this))
          ),
          250
        );
      ...
      _proto.renderChildren = function renderChildren() {
        ...
        return React__default.Children.toArray(this.props.children)
          .filter(isVideoChild)
          .map(function(c) {
            var cprops;
  ...
  var Shortcut =
    ...
    (function(_Component) {
      ...
      _proto.mergeShortcuts = function mergeShortcuts() {
        ...
        var defaultShortcuts = this.defaultShortcuts.reduce(function(
          shortcuts,
          shortcut
        ) {
          var _Object$assign;
          ...
          return Object.assign(
            shortcuts,
            ((_Object$assign = {}),
            (_Object$assign[getShortcutKey(shortcut)] = shortcut),
            _Object$assign)
          );
        },
        {});
        var mergedShortcuts = (this.props.shortcuts || []).reduce(function(
          shortcuts,
          shortcut
        ) {
          ...
          if (keyCode && typeof handle === 'function') {
            ...
            return Object.assign(
              shortcuts,
              ((_Object$assign2 = {}),
              (_Object$assign2[getShortcutKey(shortcut)] = shortcut),
              _Object$assign2)
            );
          }
      ...
      _proto.handleKeyPress = function handleKeyPress(e) {
        ...
        if (
          ...
          hasClass(document.activeElement, 'video-react-menu-button-active') || // || hasClass(document.activeElement, 'video-react-slider')
  ...
  var Slider =
    ...
    (function(_Component) {
      ...
      _proto.renderChildren = function renderChildren() {
        ...
        return React__default.Children.map(this.props.children, function(
          child
        ) {
  ...
  function TimeDivider(_ref) {
    ...
    return React__default.createElement(
      ...
      React__default.createElement(
        'div',
        null,
        React__default.createElement('span', null, separatorText)
      )
    );
  }
  ...
  var VolumeBar =
    ...
    (function(_Component) {
      ...
      _proto.handlePercentageChange = function handlePercentageChange(
        percentage
      ) {
  ...
  var MenuButton =
    ...
    (function(_Component) {
      ...
      function MenuButton(props, context) {
        ...
        _this.commitSelection = _this.commitSelection.bind(
          _assertThisInitialized(_assertThisInitialized(_this))
        );
        _this.activateMenuItem = _this.activateMenuItem.bind(
          _assertThisInitialized(_assertThisInitialized(_this))
        );
        _this.handleClick = _this.handleClick.bind(
          _assertThisInitialized(_assertThisInitialized(_this))
        );
        _this.renderMenu = _this.renderMenu.bind(
          _assertThisInitialized(_assertThisInitialized(_this))
        );
        _this.handleFocus = _this.handleFocus.bind(
          _assertThisInitialized(_assertThisInitialized(_this))
        ...
        _this.handleUpArrow = _this.handleUpArrow.bind(
          _assertThisInitialized(_assertThisInitialized(_this))
        );
        _this.handleDownArrow = _this.handleDownArrow.bind(
          _assertThisInitialized(_assertThisInitialized(_this))
        );
        _this.handleEscape = _this.handleEscape.bind(
          _assertThisInitialized(_assertThisInitialized(_this))
        );
        _this.handleReturn = _this.handleReturn.bind(
          _assertThisInitialized(_assertThisInitialized(_this))
        );
        _this.handleTab = _this.handleTab.bind(
          _assertThisInitialized(_assertThisInitialized(_this))
        );
        _this.handleKeyPress = _this.handleKeyPress.bind(
          _assertThisInitialized(_assertThisInitialized(_this))
        ...
        _this.handleIndexChange = _this.handleIndexChange.bind(
          _assertThisInitialized(_assertThisInitialized(_this))
        );
        return _this;
      }
  ...
  var ControlBar =
    ...
    (function(_Component) {
      ...
      _proto.getDefaultChildren = function getDefaultChildren() {
        return [
          React__default.createElement(PlayToggle, {
            key: 'play-toggle',
            order: 1
          }),
      ...
      _proto.getChildren = function getChildren() {
        ...
        var _this$props = this.props,
          className = _this$props.className,
          parentProps = _objectWithoutPropertiesLoose(_this$props, [
            'className'
          ]); // remove className
    ...
    (function(_Component) {
      ...
      _proto.getChildren = function getChildren(props) {
        var _ = props.className,
          ...
          propsWithoutChildren = _objectWithoutPropertiesLoose(props, [
            'className',
            'children'
          ]);

        var children = React__default.Children.toArray(
          this.props.children
        ).filter(function(e) {
      ...
      _proto.startControlsTimer = function startControlsTimer() {
        ...
        React__default.Children.forEach(this.props.children, function(element) {
          if (
            !React__default.isValidElement(element) ||
            element.type !== ControlBar
          ) {
            return;
          }
